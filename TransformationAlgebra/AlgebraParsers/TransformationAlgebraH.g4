	grammar TransformationAlgebraH;
	...
	*/
	...
	//Function types
	//uf  : 	(r2r | r2v | v2r| rr2v | v2v | rr2rr | rr2r);
	bf	:	(vTv2v);
	...
	//boolv : v WHITESPACE EQUAL WHITESPACE v | ordv WHITESPACE LEQ WHITESPACE ordv;
	...
	//Function upcasting rules
	ratiovTratiov2ratiov : RATIO ;	
	vTv2boolv : EQUAL ;
	ordvTordv2boolv : LEQ ;
	vTv2v : ratiovTratiov2ratiov | ordvTordv2boolv | vTv2boolv ;
